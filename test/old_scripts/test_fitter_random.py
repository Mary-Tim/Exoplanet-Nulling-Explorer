...
bounds = [(2000000, 10000000), (100., 800.), tuple(fov), tuple(fov)]
...
scat = ax.scatter(ra_result*cons._radian_to_mas, dec_result*cons._radian_to_mas, s=50, c=nll_grid, cmap=plt.get_cmap("bwr"))
