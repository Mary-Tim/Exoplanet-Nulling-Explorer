...
trans_map_cont = ax.contourf(ra_grid_numpy*cons._radian_to_mac, dec_grid_numpy*cons._radian_to_mac, trans_map, levels=levels, cmap = plt.get_cmap("bwr"))
