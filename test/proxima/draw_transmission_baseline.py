...
def draw_a_point(ax, baseline):
    ...
    obs_config['Observation']['Baseline']['Value'] = baseline
    ...
    color = next(cycol)
    trans_map_cont = ax.plot(ra_numpy*cons._radian_to_mas, trans_map, color=color, label=f"B: {baseline:d}m")
