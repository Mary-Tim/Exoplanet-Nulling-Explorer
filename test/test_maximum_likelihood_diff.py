...
spectrum_bins = 30
integral_time = 278.
earth_location=np.array([62.5, 78.1]) / cons._radian_to_mac
...
trans_map_cont = ax.contourf(ra_grid_numpy*cons._radian_to_mac, dec_grid_numpy*cons._radian_to_mac, nll_grid, levels=levels, cmap = plt.get_cmap("bwr_r"))
...
plt.savefig('fig/maximum_likelihood_diff.pdf')
plt.show()